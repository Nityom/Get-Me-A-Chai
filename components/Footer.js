    ...
    <footer className='bg-gray-950 text-white flex flex-col md:flex-row justify-between items-center py-6 px-4 md:px-10 gap-6'>
      <div className='flex flex-col items-center md:items-start gap-2 md:gap-6'>
        <div className='flex flex-col items-center md:items-start gap-2'>
          ...
          <div className='text-xs md:text-sm text-gray-500'>Made by Nityom Tikhe with ❤</div>
        </div>
      ...
      <div className='flex flex-col items-center gap-3'>
        ...
        <div className='flex gap-4 items-center'>
          <a href="https://github.com/Nityom" target='_blank' className='border border-zinc-400 py-2 px-3 rounded-full hover:bg-gray-800 transition-colors flex items-center gap-2'>
            <PiGithubLogoBold className='w-5 h-5'/>
            <span className='hidden md:inline'>GitHub</span>
          </a>
          <a href="https://www.linkedin.com/in/nityom-tikhe-bb53b3249" target='_blank' className='border border-zinc-400 py-2 px-3 rounded-full hover:bg-gray-800 transition-colors flex items-center gap-2'>
