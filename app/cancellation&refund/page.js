    ...
    <div className="bg-black py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto">
        ...
        <ul className="list-disc pl-6 mb-6">
          ...
          <li className="text-gray-200">In the event of a fraudulent campaign, please contact us immediately at <a href="mailto:bitbybit789@gmail.com" className="text-blue-500 hover:underline">bitbybit789@gmail.com.com</a> for assistance.</li>
        </ul>
        ...
        <p className="text-gray-200">
          If you have any questions or need further assistance, please reach out to us at <a href="mailto:bitbybit789@gmail.com" className="text-blue-500 hover:underline">bitbybit789@gmail.com.com</a>.
        </p>
        <div
