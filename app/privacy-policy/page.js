  ...
  return (
    <div className="bg-black py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto">
        ...
        <p className="text-gray-200 mb-6">
          <strong>Your Rights:</strong> You have the right to access, update, and delete your personal information. To exercise these rights, please contact us at <a href="mailto:support@getmeachai.com" className="text-blue-500 hover:underline">bitbybit789@gmail.com</a>.
        </p>
